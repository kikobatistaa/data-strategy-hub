...
export const en = {
  ...
  hero: {
    ...
    headline: ["Investment advisory.", "Data underneath."],
    lead: "I advise private-equity funds and financial institutions on NPL and REO portfolio acquisitions at Finsolutia: due diligence, valuation benchmarks, deal support. The models underneath are built in Python, by me.",
    ...
    roles: [
      {
        ...
        location: "Madrid",
        summary: "Investor advisory for private-equity funds and financial institutions acquiring NPL and REO portfolios.",
        bullets: [
