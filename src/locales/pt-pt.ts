...
export const ptPT: Translation = {
  ...
  hero: {
    eyebrow: "Advisory Analyst · Finsolutia · Madrid",
    headline: ["Assessoria de investimento.", "Dados por trás."],
    lead: "Na Finsolutia, aconselho fundos de private equity e instituições financeiras na aquisição de carteiras NPL e REO: due diligence, benchmarks de valuation, apoio à negociação. Os modelos por trás são construídos em Python, por mim.",
    ctaWork: "Trabalho selecionado",
    ctaHello: "Diga olá",
    portraitAlt: "Francisco Cordeiro Batista",
    portraitCaption: "Madrid, 2026",
    linkedin: "LinkedIn",
    github: "GitHub",
  },
  glance: {
    ...
    roles: [
      {
        ...
        location: "Madrid",
        summary: "Assessoria a fundos de private equity e instituições financeiras na aquisição de carteiras NPL e REO.",
        bullets: [
  ...
  footer: {
    tagline: "Advisory Analyst, Finsolutia · Madrid",
    linkedin: "LinkedIn",
    github: "GitHub",
    email: "Email",
    cv: "CV",
