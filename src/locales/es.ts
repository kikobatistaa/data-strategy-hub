...
export const es: Translation = {
  ...
  hero: {
    ...
    headline: ["Asesoramiento de inversión.", "Datos detrás."],
    lead: "En Finsolutia asesoro a fondos de private equity e instituciones financieras en la adquisición de carteras NPL y REO: due diligence, benchmarks de valoración, apoyo en la negociación. Los modelos que hay detrás están hechos en Python, por mí.",
    ...
    roles: [
      {
        ...
        location: "Madrid",
        summary: "Asesoramiento a fondos de private equity e instituciones financieras en la adquisición de carteras NPL y REO.",
        bullets: [
